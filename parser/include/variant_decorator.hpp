...
//{
template<class... S>
struct variant_decorator: public x3::variant<S...>
{
    using x3::variant<S...>::operator=;
    using x3::variant<S...>::variant;
    ...
    T& as()
    {
        const_cast<T&>(const_cast<const variant_decorator *>(this)->as<T>());
    }
